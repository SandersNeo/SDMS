...
Процедура ВыборШаблонаНовогоРегламентногоЗадания()
	...
	ОписанияМетаданныхРегламентныхЗаданий.ПоказатьВыборЭлемента(
		...
		"Выберите шаблон регламентного задания");
...
Процедура ОбновитьЗаголовокФормы()
	...
	Если Действие = "Изменить" Тогда
		Заголовок = СтрШаблон("%1 (Регламентное задание)", Представление);
	Иначе
		Заголовок = "Регламентное задание (создание)";
	КонецЕсли;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Действие = "Добавить" Тогда
		...
		ЗависимостиЗаданий     = РегламентныеЗаданияСервер.РегламентныеЗаданияЗависимыеОтФункциональныхОпций();
